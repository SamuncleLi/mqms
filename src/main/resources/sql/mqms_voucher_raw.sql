...
CREATE TABLE `mqms_voucher_raw` (
  ...
  `dealer_short_name` varchar(255) DEFAULT NULL,
  ...
  `division_level_1` varchar(255) DEFAULT NULL,
  `division_level_2` varchar(255) DEFAULT NULL,
  `division_level_3` varchar(255) DEFAULT NULL,
  `parts_and_symptom` varchar(255) DEFAULT NULL,
  ...
  `warehousing_date` varchar(255) DEFAULT NULL,
  `transport_date` varchar(255) DEFAULT NULL COMMENT '车辆发运时间',
  `shop_arrival_date` varchar(255) DEFAULT NULL COMMENT '到店时间',
  `sales_failure_time` int(11) DEFAULT NULL,
  `failure_desc` varchar(255) DEFAULT NULL,
  ...
  `submit_date` varchar(255) DEFAULT NULL COMMENT '上报日期',
  `egtype_code` varchar(255) DEFAULT NULL,
