...
/**
 * Created by Zeho Lee on 2019/7/19.
 */
public class CryptoUtil {
    private final static String defaultKey = "90719163";
//    private final static String defaultKey = "12345678";
//    public static void main(String[] args) throws Exception {
//        String data = "9534ca5b6bc67e4c";
////         System.err.println(encrypt(data, defaultKey));
//        // System.err.println(decrypt(encrypt(data, key), key));
//        //System.out.println(encrypt(data));
//        System.out.println(encrypt("1732",  defaultKey));
//        System.out.println(defaultKey.getBytes());
//        System.out.println(decrypt(data, defaultKey));
//
//    }
    ...
    public CryptoUtil(String strKey) throws Exception {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CryptoUtil des1 = new CryptoUtil();// 使用默认密钥
            ...
            CryptoUtil des2 = new CryptoUtil(key);// 自定义密钥
